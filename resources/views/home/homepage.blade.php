...
<head>
    ...
    <meta name="description" content="meatiano">
    <meta name="keywords" content="meatiano">
    <meta name="author" content="meatiano">
    <link rel="icon" href="template/assets/images/favicon/5.png" type="image/x-icon">
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="template/assets/css/vendors/bootstrap.css">
    ...
    <link rel="stylesheet" href="template/assets/css/vendors/ion.rangeSlider.min.css">

    <!-- slick css -->
    <link rel="stylesheet" type="text/css" href="template/assets/css/vendors/slick/slick.css">
    <link rel="stylesheet" type="text/css" href="template/assets/css/vendors/slick/slick-theme.css">

    <!-- animation css -->
    <link rel="stylesheet" type="text/css" href="template/assets/css/font-style.css">

    <!-- Template css -->
    <link id="color-link" rel="stylesheet" type="text/css" href="template/assets/css/style.css">
</head>
...
<body class="theme-color-3 dark">
    ...
    <!-- Header Start -->
    <header class="pb-md-4 pb-0 theme-bg-color">

        <div class="top-nav top-header sticky-header theme-bg-color">
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <a href="index.html" class="web-logo nav-logo">
                                <img src="template/assets/images/logo/logo.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </a>
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="template/assets/images/vegetable/product/1.png"
                                                    ...
                                                    <li class="product-box-contain">
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="template/assets/images/vegetable/product/2.png"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>
                                ...
                                <ul class="category-list">
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/vegetable.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/cup.svg" alt="">
                                            <h6>Beverages</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/meats.svg" alt="">
                                            <h6>Meats & Seafood</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/breakfast.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/frozen.svg" alt="">
                                            <h6>Frozen Foods</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/biscuit.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="template/assets/svg/1/grocery.svg" alt="">
    ...
    <section class="overflow-hidden pt-0">
        <div class="container-fluid">
            <div class="home-slider arrow-slider slick-height">
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="template/assets/images/new/slide-banner-min.webp" class="img-fluid"
                                        alt="">
                                </div>
                            </div>
                        </div>
    ...
    <section class="banner-section banner-small ratio_65 mt-5">
        <div class="container-fluid-lg mb-5">
            <div class="row">
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/premium-min.webp"
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">premium</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/chiken-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">Chicken</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/mutton-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">mutton</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/fish&seafood-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">fish & seafood</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/ready-to-cook-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">ready to cook</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/EGG-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">EGGS</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/cold-cut-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">cold cuts</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/gym-lover-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">gym lover</h2>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class=" blog-box ratio_45 mb-4">
                        <div class="blog-box-image custom-grey">
                            <a href="blog-detail.html">
                                <img src="template/assets/images/new/cateogries/by-by-fat-min.webp"
                                    class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                        ...
                        <div class="blog-detail">
                            <a href="#">
                                <h2 class="text-center text-uppercase">bye bye fat</h2>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="slider-animate">
                        <div>
                            <div class="home-contain rounded-0 p-0">
                                <img src="template/assets/images/new/offer-banner-min.webp"
                                    class="img-fluid bg-img blur-up lazyload" alt="">
                                <div class="home-detail home-big-space p-center-left home-overlay position-relative">
                                    <div class="container-fluid-lg">
                                        <div>
                                            <h6 class="ls-expanded theme-color text-uppercase"> <br>
    ...
    <section class="top-selling-section my-4">
        <div class="container-fluid-lg">
                            ...
                            <div class="top-selling-box">
                                ...
                                <div class="top-selling-contain wow fadeInUp">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/chicken-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">Chicken</h5>
                                        </a>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.05s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/fishseafood-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">fish & sea food</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.1s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/mutton-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">mutton</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="top-selling-box">
                                ...
                                <div class="top-selling-contain wow fadeInUp">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/ready-to-cook-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">ready to cook</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.05s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/eggs-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">Eggs</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.1s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/kabab-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">kabab</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="top-selling-box">
                                ...
                                <div class="top-selling-contain wow fadeInUp">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/prawns-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">prawns</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.05s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/cold-cuts-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">cold cuts</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
                                ...
                                <div class="top-selling-contain wow fadeIn" data-wow-delay="0.1s">
                                    <a href="product-left-thumbnail.html" class="top-selling-image">
                                        <img src="template/assets/images/new/top_selling/meat-masalla-min.webp"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>

                                    <div class="top-selling-detail">
                                        <a href="product-left-thumbnail.html">
                                            <h5 class="text-uppercase">meat masalla</h5>
                                        </a>
                                        <div class="product-rating">
                                            <ul class="rating">
                                                <li>
    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
                        ...
                        <div class="service-contain">
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="template/assets/svg/product.svg" class="blur-up lazyload"
                                        alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="template/assets/svg/delivery.svg" class="blur-up lazyload"
                                        alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="template/assets/svg/discount.svg" class="blur-up lazyload"
                                        alt="">
                                </div>
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="template/assets/svg/market.svg" class="blur-up text-dark lazyload"
                                        alt="">
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            <div class="theme-logo">
                                <a href="index.html">
                                    <img src="template/assets/images/logo/logo.png" class="blur-up lazyload"
                                        alt="">
                                </a>
                            </div>
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="https://play.google.com/store/apps" target="_blank">
                                                <img src="template/assets/images/playstore.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="https://www.apple.com/in/app-store/" target="_blank">
                                                <img src="template/assets/images/appstore.svg"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="payment">
                    <img src="template/assets/images/payment/1.png" class="blur-up lazyload" alt="">
                </div>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="template/assets/images/product/category/1.jpg"
                                    class="img-fluid blur-up lazyload" alt="">
                            </div>
                        </div>
    ...
    <script src="template/assets/js/bootstrap/bootstrap-notify.min.js"></script>
    <script src="template/assets/js/bootstrap/popper.min.js"></script>

    <!-- feather icon js-->
    <script src="template/assets/js/feather/feather.min.js"></script>
    <script src="template/assets/js/feather/feather-icon.js"></script>

    <!-- Lazyload Js -->
    <script src="template/assets/js/lazysizes.min.js"></script>

    <!-- Slick js-->
    <script src="template/assets/js/slick/slick.js"></script>
    <script src="template/assets/js/slick/slick-animation.min.js"></script>
    <script src="template/assets/js/custom-slick-animated.js"></script>
    <script src="template/assets/js/slick/custom_slick.js"></script>

    <!-- Range slider js -->
    <script src="template/assets/js/ion.rangeSlider.min.js"></script>

    <!-- Auto Height Js -->
    <script src="template/assets/js/auto-height.js"></script>

    <!-- Lazyload Js -->
    <script src="template/assets/js/lazysizes.min.js"></script>

    <!-- Quantity js -->
    <script src="template/assets/js/quantity-2.js"></script>

    <!-- Fly Cart Js -->
    <script src="template/assets/js/fly-cart.js"></script>

    <!-- Timer Js -->
    <script src="template/assets/js/timer1.js"></script>
    <script src="template/assets/js/timer2.js"></script>

    <!-- Copy clipboard Js -->
    <script src="template/assets/js/clipboard.min.js"></script>
    <script src="template/assets/js/copy-clipboard.js"></script>

    <!-- WOW js -->
    <script src="template/assets/js/wow.min.js"></script>
    <script src="template/assets/js/custom-wow.js"></script>
