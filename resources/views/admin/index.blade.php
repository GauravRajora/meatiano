...
<head>
    ...
    <!-- Linear Icon css -->
    <link rel="stylesheet" href="template/assets/css/linearicon.css">
    ...
    <!-- ratio css -->
    <link rel="stylesheet" type="text/css" href="template/assets/css/ratio.css">

    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="template/assets/css/remixicon.css">
    ...
    <!-- Slick Slider Css -->
    <link rel="stylesheet" href="template/assets/css/vendors/slick.css">
...
<body>
            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo" src="template/assets/images/logo/1.png" alt="logo">
                            <img class="img-fluid white-logo" src="template/assets/images/logo/1-white.png" alt="logo">
                        </a>
                    </div>
                    <div class="toggle-sidebar">
                        <i class="status_toggle middle sidebar-toggle" data-feather="align-center"></i>
                        <a href="index.html">
                            <img src="template/assets/images/logo/1.png" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                <img class="user-profile rounded-circle" src="template/assets/images/users/4.jpg" alt="">
                ...
                <div>
                    <div class="logo-wrapper logo-wrapper-center">
                        <a href="index.html" data-bs-original-title="" title="">
                            <img class="img-fluid for-white" src="template/assets/images/logo/full-white.png" alt="logo">
                        </a>
                        <div class="back-btn">
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo main-white" src="template/assets/images/logo/logo.png" alt="logo">
                            <img class="img-fluid main-logo main-dark" src="template/assets/images/logo/logo-white.png"
                                alt="logo">
                        </a>
                    </div>
                                ...
                                <div class="card-body p-0">
                                    <div class="category-slider no-arrow">
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/vegetable.svg" class="img-fluid" alt="">
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/cup.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Beverages</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/meats.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Meats & Seafood</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/breakfast.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Breakfast</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/frozen.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Frozen Foods</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/milk.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Milk & Dairies</h6>
                                                </a>
                                        ...
                                        <div>
                                            <div class="dashboard-category">
                                                <a href="javascript:void(0)" class="category-image">
                                                    <img src="template/assets/svg/pet.svg" class="img-fluid" alt="">
                                                </a>
                                                <a href="javascript:void(0)" class="category-name">
                                                    <h6>Pet Food</h6>
                                                </a>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="template/assets/images/product/1.png"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="template/assets/images/product/2.png"
                                                                        class="img-fluid" alt="Product">
                                                                </div>
                                                                <div class="product-name">
                                                                    <h5>Aata Buscuit</h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="best-product-box">
                                                                <div class="product-image">
                                                                    <img src="template/assets/images/product/3.png"
                                                                        class="img-fluid" alt="Product">
                                                                </div>
                                                                <div class="product-name">
                                                                    <h5>Aata Buscuit</h5>
    ...
    <!-- Apexchar js -->
    <script src="template/assets/js/chart/apex-chart/apex-chart1.js"></script>
    <script src="template/assets/js/chart/apex-chart/moment.min.js"></script>
    ...
    <script src="template/assets/js/chart/apex-chart/chart-custom1.js"></script>


    <!-- slick slider js -->
    <script src="template/assets/js/slick.min.js"></script>
    <script src="template/assets/js/custom-slick.js"></script>

    <!-- customizer js -->
    <script src="template/assets/js/customizer.js"></script>

    <!-- ratio js -->
    <script src="template/assets/js/ratio.js"></script>

    <!-- sidebar effect -->
    <script src="template/assets/js/sidebareffect.js"></script>
